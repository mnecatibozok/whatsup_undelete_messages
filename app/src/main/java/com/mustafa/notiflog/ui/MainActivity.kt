...
import com.mustafa.notiflog.data.MessageDao
import com.mustafa.notiflog.databinding.ActivityMainBinding
import com.mustafa.notiflog.media.MediaWatcherService
import kotlinx.coroutines.launch

/**
 * Ana ekran: doğrudan, sadece karşı tarafın sildiği mesajların düz listesi.
 * Ekstra tıklama/ekran/ayar yok — uygulama açılır açılmaz silinen mesajlar görünür.
 */
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchBox.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                observeDeleted(s?.toString().orEmpty())
            }
    ...
    private fun observeDeleted(query: String) {
        val liveData = if (query.isBlank()) dao.getDeletedOnly() else dao.searchDeleted(query)
