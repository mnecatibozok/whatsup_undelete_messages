...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ConversationAdapter { conversation ->
            ...
            intent.putExtra(ConversationDetailActivity.EXTRA_CONVERSATION_TITLE, conversation.conversationTitle)
        ...
        binding.searchBox.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                observeConversations(s?.toString().orEmpty())
            }
    ...
    private fun observeConversations(query: String) {
        val liveData = if (query.isBlank()) dao.getConversations() else dao.searchConversations(query)
